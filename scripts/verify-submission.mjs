...
const required = ['README.md', 'PROPOSAL.md', 'TESTING.md', 'src/test/feedback.test.ts', 'deployment.json', 'SECURITY.md', 'OPERATIONS.md', 'src/runtimeConfig.ts', 'src/test/runtime-config.test.ts'];
