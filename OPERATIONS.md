# Operations runbook — Anonymous Feedback Board
...
2. Confirm contract `feedback` and its address against `deployment.json`.
3. Confirm the wallet has sufficient NIGHT/DUST and is synchronized.
4. Load every proving/verifier asset from `public/midnight/feedback`.
...
Pause submissions, keep message content out of diagnostic logs, preserve public chain evidence, and publish a safe alternate reporting channel.
